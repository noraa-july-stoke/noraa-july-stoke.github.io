// import { ASCIIVideo } from "./ASCII_video.js";
...
function drawTriangle() {
  ctx.strokeStyle = "#00a86b"; // "#00a86b",

  ctx.lineWidth = 2;
  const height = canvas.height;
  const base = (height * Math.sqrt(3)) / 1.5; // Calculate the base length of the equilateral triangle
